...
public class GameMain {
    ...
    private static void createAndShowGUI() {
        ...
        // score.
        game.addPropertyChangeListener(e-> {
    ...
    private static void addSliderLabels(JSlider slider, String minLabel,
        ...
        labels.put(slider.getMinimum(), new JLabel(minLabel)); // 1
        labels.put(slider.getMaximum(), new JLabel(maxLabel)); // 2
        slider.setLabelTable(labels); // 3
        slider.setPaintLabels(true);  // 3
    }
