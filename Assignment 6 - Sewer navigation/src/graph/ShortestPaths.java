...
public class ShortestPaths<Vertex, Edge> {
    ...
    public void singleSourceDistances(Vertex source) {
        ...
        // source = starting point, 0 = starting distance
        frontier.add(source, 0.0);
        // origin of the starting source ie: starting source always at 0
        ...
        while (!frontier.isEmpty()) {
            ...
            for (Edge e : graph.outgoingEdges(v)) {
                ...
                double vDist = distances.get(v);
                double dist = vDist + graph.weight(e);
