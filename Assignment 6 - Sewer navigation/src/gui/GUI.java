...
public class GUI extends JFrame {
    ...
    /**
     * Move the diver on the GUI to destination dest, and block until the diver has completed the
     * move. Requires: dest is adjacent to the diver's current location
     */
    ...
    public synchronized void finishAnimating() {
        animating = false; // animating is finished
        this.notifyAll(); // Wake up all threads that are currently waiting for the animation to
        // complete.
    }
}
